...
- **Global scope**: `/Users/theogengineer/Projects/Multilingual-Absa/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/theogengineer/Projects/Multilingual-Absa/.opencode/notes/`)
...
2. Glob `/Users/theogengineer/Projects/Multilingual-Absa/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/theogengineer/Projects/Multilingual-Absa/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/theogengineer/Projects/Multilingual-Absa/.opencode/notes/` — works in any directory
