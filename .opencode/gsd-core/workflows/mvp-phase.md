...
@/Users/theogengineer/Projects/Multilingual-Absa/.opencode/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/theogengineer/Projects/Multilingual-Absa/.opencode/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/theogengineer/Projects/Multilingual-Absa/.opencode/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/theogengineer/Projects/Multilingual-Absa/.opencode/gsd-core/references/spidr-splitting.md`. Briefly:
