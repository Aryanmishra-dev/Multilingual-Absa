...
```
Agent(
  prompt="Read /Users/theogengineer/Projects/Multilingual-Absa/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/theogengineer/Projects/Multilingual-Absa/.opencode/gsd-core/templates/SECURITY.md`
