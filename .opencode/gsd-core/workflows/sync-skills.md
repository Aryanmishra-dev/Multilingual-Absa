...
INSTALL_JS_GLOBAL="/Users/theogengineer/Projects/Multilingual-Absa/.opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/theogengineer/Projects/Multilingual-Absa/.opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
