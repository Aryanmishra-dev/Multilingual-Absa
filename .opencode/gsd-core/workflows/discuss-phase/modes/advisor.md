...
> `/Users/theogengineer/Projects/Multilingual-Absa/.opencode/gsd-core/USER-PROFILE.md` exists). Skip the Read
...
```bash
PROFILE_CONTENT=$(cat "/Users/theogengineer/Projects/Multilingual-Absa/.opencode/gsd-core/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a `Agent()` in parallel:
   ...
   ```
   Agent(
     prompt="First, read @/Users/theogengineer/Projects/Multilingual-Absa/.opencode/agents/gsd-advisor-researcher.md for your role and instructions.
