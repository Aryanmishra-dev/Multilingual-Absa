...
The keys live in `.claude/settings.json` (project) or `/Users/theogengineer/Projects/Multilingual-Absa/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
